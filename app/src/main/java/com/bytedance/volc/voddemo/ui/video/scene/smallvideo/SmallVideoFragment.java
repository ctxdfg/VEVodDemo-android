...
public class SmallVideoFragment extends VideoFragment {

    private RemoteApi mRemoteApi;
    private final Book<VideoItem> mBook = new Book<>(10);
    private SmallVideoPageView mPageView;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mPageView = (SmallVideoPageView) view;
        mPageView.setLifeCycle(getLifecycle());
        mPageView.setRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                refresh();
            }
        });
        mPageView.setLoadMoreListener(new SwipeRefreshLayout.OnRefreshListener() {
