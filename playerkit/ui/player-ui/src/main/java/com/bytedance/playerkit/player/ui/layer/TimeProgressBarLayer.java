...
public class TimeProgressBarLayer extends AnimateLayer {
    ...
    private void initFullScreen(View view) {
        ...
        ViewGroup.MarginLayoutParams lp = (ViewGroup.MarginLayoutParams) mSeekBar.getLayoutParams();
        lp.height = (int) UIUtils.dip2Px(context(), 24);
        lp.leftMargin = (int) UIUtils.dip2Px(context(), 44);
        lp.rightMargin = (int) UIUtils.dip2Px(context(), 44);
        mSeekBar.setLayoutParams(lp);
    ...
    private void syncProgress() {
        ...
        if (controller != null) {
            ...
            if (player != null) {
                if (player.isInPlaybackState()) {
                    setProgress(player.getCurrentPosition(), player.getDuration(), player.getBufferPercentage());
                }
            }
        }
    }
