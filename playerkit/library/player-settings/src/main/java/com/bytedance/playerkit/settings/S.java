...
public class S implements Settings {
    ...
    private final RemoteValues mRemoteGetter;

    public S(Context context, List<Option> options, RemoteValues remoteGetter) {
        this(context, options, new InnerUserValues(context), remoteGetter);
    }

    public S(Context context, List<Option> options, InnerUserValues userProvider, RemoteValues remoteGetter) {
    ...
    @Override
    public RemoteValues remoteValues() {
        return mRemoteGetter;
    }

    static class InnerUserValues implements UserValues {
