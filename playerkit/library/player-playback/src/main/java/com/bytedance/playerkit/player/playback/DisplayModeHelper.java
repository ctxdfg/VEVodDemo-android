...
public class DisplayModeHelper {
    ...
    public void setVideoSize(int videoWidth, int videoHeight) {
        ...
        //L.v(this, "setVideoSize", mDisplayView.getWidth(), mDisplayView.getHeight(), videoWidth, videoHeight);
        apply();
    }

    public void setSampleAspectRatio(float sar) {
        this.mSampleAspectRatio = sar;
        apply();
    }
    ...
    private void applyDisplayMode() {
        ...
        if (mDisplayAspectRatio > 0) {
            displayAspectRatio = mDisplayAspectRatio;
        } else {
            displayAspectRatio = calDisplayAspectRatio();
        }
    ...
    private float calDisplayAspectRatio() {
        ...
        if (pixelAspectRatio > 0) {
            final float sampleAspectRatio = mSampleAspectRatio;
            if (sampleAspectRatio > 0) {
                displayAspectRatio = pixelAspectRatio * sampleAspectRatio;
            } else {
