...
public class DefaultPlayerPool implements PlayerPool {
    ...
    public DefaultPlayerPool() {
        this(Player.Factory.Default.get());
    }

    public DefaultPlayerPool(Player.Factory playerFactory) {
    ...
    @NonNull
    private Player create(@NonNull MediaSource source) {
        Player player = mPlayerFactory.create(source);
