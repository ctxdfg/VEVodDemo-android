...
public abstract class DisplayView {
    ...
    static class TextureDisplayView extends DisplayView {
        ...
        private SurfaceListener surfaceListener;
        private boolean reuseSurface = true;
        ...
        static class TextureSurface extends Surface {
            ...
            private final WeakReference<SurfaceTexture> ref;

            @SuppressLint("Recycle")
            TextureSurface(SurfaceTexture surfaceTexture) {
                super(surfaceTexture);
                ref = new WeakReference<>(surfaceTexture);
            }
            ...
            public boolean isValid() {
                ...
                if (ref != null) {
                    SurfaceTexture surfaceTexture = ref.get();
                    isValid = isValid && surfaceTexture != null;
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                        isValid = isValid && !surfaceTexture.isReleased();
                    }
                }
                return isValid;
            }
